...
filename = r'C:\Users\Ephraim.Sun\Desktop\proj3\Super_Plant_final.xlsx'
...
count = 0
max_row = 0
rootdir = r'C:\Users\Ephraim.Sun\Desktop\proj3\Super Plant'
...
#
# print(max_row)
df_excel.to_excel('Super_Plant_final.xlsx', index=True)
