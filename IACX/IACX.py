...
filename = r'C:\Users\Ephraim.Sun\Desktop\proj3\IACX_final.xlsx'
...
count = 0
max_row = 0
rootdir = r'C:\Users\Ephraim.Sun\Desktop\proj3\IACX'
...
print(max_row)
df_excel.to_excel('IACX_final.xlsx', index=True)
